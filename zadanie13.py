...
def train_and_collect(lr, X_train, y_train, X_val, y_val):
...
def zad_nie13():
    ...
    # запуск для разных lr
    results = {}
    for lr in [0.001, 0.01, 0.1]:  
        losses, accs, grad_norms = train_and_collect(lr, X_train, y_train, X_val, y_val)
